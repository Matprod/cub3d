...
/*   Updated: 2025/02/18 21:59:08 by Matprod          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_vector(t_game *game, t_vector start,
...
void	draw_fov_limits(t_game *game)
{
	...
	player_pos.x = 450;
	player_pos.y = 450;
	draw_vector(game, player_pos, game->fov_left, 10000);
	draw_vector(game, player_pos, game->fov_right, 10000);
}
